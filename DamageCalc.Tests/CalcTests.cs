...
namespace DamageCalc.Tests {
  public sealed class CalcTests {
    private static void ForGens(int from, int to, Action<int> action) {
      for (var gen = from; gen <= to; gen++) action(gen);
    }
    ...
    [Test]
    public void ArceusPlate_Gen4To7() {
      ForGens(4, 7, gen => {
        var result = C(
          gen,
    ...
    [Test]
    public void NightShadeSeismicToss_Gen1To9() {
      ForGens(1, 9, gen => {
    ...
    [Test]
    public void CometPunch_AllGens() {
      ForGens(1, 9, gen => {
    ...
    [Test]
    public void NonDamaging_Gen1To9() {
      ForGens(1, 9, gen => {
    ...
    [Test]
    public void CriticalHitsIgnoreAttackDecreases_Gen1To9() {
      ForGens(1, 9, gen => {
    ...
    [Test]
    public void StruggleVsGhost_Gen1To9() {
      ForGens(1, 9, gen => {
    ...
    [Test]
    public void WeatherBall_ChangesType_Gen3To9() {
      ForGens(3, 9, gen => {
        var weathers = new[] {
          new {
            Weather = "Sun",
    ...
    [Test]
    public void FlyingPress_Gen6To9() {
      ForGens(6, 9, gen => {
    ...
    [Test]
    public void ThousandArrows_RingTarget_Gen6To9() {
      ForGens(6, 9, gen => {
    ...
    [Test]
    public void RingTarget_Nullifies_Gen5To9() {
      ForGens(5, 9, gen => {
    ...
    [Test]
    public void IvsShownIfApplicable_Gen3To9() {
      ForGens(3, 9, gen => {
    ...
    [Test]
    public void IronBall_Negates_Gen4To9() {
      ForGens(4, 9, gen => {
    ...
    [Test]
    public void Multiscale_ShadowShield_Gen5To9() {
      ForGens(5, 9, gen => {
    ...
    [Test]
    public void PsychicTerrain_Gen7To9() {
      ForGens(7, 9, gen => {
    ...
    [Test]
    public void ParentalBond_Gen6To9() {
      ForGens(6, 9, gen => {
        var result = C(
          gen,
    ...
    [Test]
    public void KnockOffVsKlutz_Gen6To9() {
      ForGens(6, 9, gen => {
    ...
    [Test]
    public void MultiHitPercentageKill_Gen1To9() {
      ForGens(1, 9, gen => {
        if (gen < 3) {
          var result = C(
            gen,
    ...
    [Test]
    public void KnockOffVsZacianCrowned_Gen8To9() {
      ForGens(8, 9, gen => {
        var weavile = P(gen, "Weavile");
    ...
    [Test]
    public void MultiHitWithMultiscale_Gen5To9() {
      ForGens(5, 9, gen => {
        var result = C(
          gen,
          P(gen, "Mamoswine"),
    ...
    [Test]
    public void MultiHitWithWeakArmor_Gen5To9() {
      ForGens(5, 9, gen => {
        var result = C(
          gen,
          P(gen, "Mamoswine"),
    ...
    [Test]
    public void MultiHitWithMummy_Gen6To9() {
      ForGens(6, 9, gen => {
        var result = C(
          gen,
          P(gen, "Pinsir-Mega"),
    ...
    [Test]
    public void MultiHitWithItems_Gen7To9() {
      ForGens(7, 9, gen => {
        var result = C(
          gen,
          P(gen, "Greninja"),
    ...
    [Test]
    public void KoedPokemon_NoRecovery_5PlusTurns_Gen3To9() {
      ForGens(3, 9, gen => {
    ...
    [Test]
    public void KoedPokemon_NoRecovery_1To4Turns_Gen3To9() {
      ForGens(3, 9, gen => {
    ...
    [Test]
    public void EndOfTurnDamage_5PlusTurns_Gen3To9() {
      ForGens(3, 9, gen => {
    ...
    [Test]
    public void EndOfTurnDamage_1To4Turns_Gen3To9() {
      ForGens(3, 9, gen => {
    ...
    [Test]
    public void EndOfTurnDamage_FirstTurn_Gen3To9() {
      ForGens(3, 9, gen => {
    ...
    [Test]
    public void MoldBreakerDoesNotDisable_NonDamageAbilities_Gen4To9() {
      ForGens(4, 9, gen => {
    ...
    [Test]
    public void SteelySpirit_FieldEffect_Gen8To9() {
      ForGens(8, 9, gen => {
    ...
    [Test]
    public void ShellSideArm_Gen8To9() {
      ForGens(8, 9, gen => {
    ...
    [Test]
    public void Gen1_Basic_GengarChansey() {
    ...
    public void Gen2_Basics() {
      ...
      result = C(2, attacker, defender, M(2, "Struggle"));
      Assert.That(result.Range(), Is.EqualTo((37, 44)));
      Assert.That(result.Desc(), Is.EqualTo(
        "+6 Skarmory Struggle vs. +6 Skarmory: 37-44 (11.1 - 13.2%) -- possible 8HKO"
      ));

      attacker = P(2, "Togepi", new State.Pokemon { Level = 5, Boosts = new StatsTableInput { Atk = -6 }, Status = "brn" });
      defender = P(2, "Umbreon", new State.Pokemon { Boosts = new StatsTableInput { Def = 6 } });
      var field = F(new State.Field { DefenderSide = new State.Side { IsReflect = true } });
      result = C(2, attacker, defender, M(2, "Present"), field);
      ...
      result = C(2, aerodactyl, zapdos, M(2, "Ancient Power"));
    ...
    public void Gen3_Basics() {
      ...
      result = C(3, gengar, blissey, M(3, "Explosion"), field);
      ...
      gengar = P(3, "Gengar", new State.Pokemon { Nature = "Modest", Evs = new StatsTableInput { Spa = 252 } });
      result = C(3, gengar, blissey, M(3, "Blizzard"), field);
    ...
    public void Gen4_Basics() {
      ...
      result = C(4, scizor, chansey, bugbite);
      Assert.That(result.Desc(), Is.EqualTo(
    ...
    public void Gen5_Basics() {
      ...
      result = C(5, ambipom, blissey, M(5, "Low Kick"));
    ...
    public void Gen7_Basics() {
      ...
      result = C(7, abomasnow, hoopa, zMove);
      ...
      result = C(7, abomasnow, hoopa, M(7, "Wood Hammer"));
      ...
      result = C(7, bigRoot, abomasnow, M(7, "Drain Punch"));
      ...
      result = C(7, bigRoot, weak, M(7, "Drain Punch"));
      ...
      result = C(7, abomasnow, hoopa, M(7, "Blizzard"), field);
      ...
      result = C(7, smeargle, blissey, M(7, "Wring Out"));
      ...
      field = F(new State.Field { Weather = "Rain", AttackerSide = new State.Side { IsHelpingHand = true } });
    ...
    public void Gen8_Basics() {
      ...
      result = C(8, sawk, silvally, knockoff);
      Assert.That(result.Desc(), Is.EqualTo(
      ...
      silvally = P(8, "Silvally");
      var hypervoice = M(8, "Hyper Voice");
      result = C(8, sylveon, silvally, hypervoice);
      Assert.That(result.Desc(), Is.EqualTo(
      ...
      result = C(8, abomasnow, deerling, blizzard, hail);
      Assert.That(result.Desc(), Is.EqualTo(
      ...
      result = C(8, kyurem, jirachi, earthpower);
      Assert.That(result.Desc(), Is.EqualTo(
      ...
      result = C(8, ambipom, blissey, M(8, "Low Kick"));
      Assert.That(result.Range(), Is.EqualTo((272, 320)));
      Assert.That(result.Desc(), Is.EqualTo(
        "0 Atk Technician Ambipom Low Kick (60 BP) vs. 252 HP / 0 Def Blissey: 272-320 (75.1 - 88.3%) -- guaranteed 2HKO"
      ));
    ...
    public void Gen9_Basics() {
      ...
      defender2 = P(9, "Iron Valiant", new State.Pokemon { Ability = "Quark Drive", Item = "Blunder Policy" });
      var field3 = F(new State.Field { Weather = "Sun" });
      knockOff = C(9, smeargle, defender2, M(9, "Knock Off"), field3);
      Assert.That(knockOff.RawDesc.MoveBP, Is.EqualTo(97.5));
      poltergeist = C(9, smeargle, defender2, M(9, "Poltergeist"), field3);
      Assert.That(poltergeist.Move.Bp, Is.EqualTo(110));
      ...
      nihilResult = C(9, attacker8, defenderB, nihilLight);
      otherResult = C(9, attacker8, defenderB, otherMove);
      ...
      nihilResult = C(9, attacker8, defenderC, nihilLight);
      otherResult = C(9, attacker8, defenderC, otherMove);
    ...
    [Test]
    public void ScreensBreakers_Gen3To9() {
      ForGens(3, 9, gen => {
